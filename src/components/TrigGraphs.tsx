      ...
      <div className="flex gap-2">
        {(["sin", "cos", "tan"] as TrigFunc[]).map((fn) => (
          <button
            ...
            className={`rounded-lg px-4 py-2.5 sm:py-2 text-sm font-medium transition-colors flex-1 sm:flex-none ${
              activeFunc === fn
                ? "text-white"
                : "bg-surface text-muted border border-border hover:border-primary active:bg-primary-light"
            }`}
            style={
              activeFunc === fn
